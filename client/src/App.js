		...
		return(
			<div className="w3-container">
				...
				<div className="w3-container w3-row w3-padding-64">
					<div className="w3-col w3-green l8 m8 s12 w3-display-container w3-padding" style={{maxHeight : '480px', height :  '60vw'}}>
						<div className="w3-display-bottomleft w3-container w3-padding">
							<i class="fa fa-eye w3-text-black" aria-hidden="true"></i>
						</div>
					</div>
